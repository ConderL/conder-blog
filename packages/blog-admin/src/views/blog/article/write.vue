  ...
  <div class="app-container">
    ...
    >
      <template #defToolbars>
        ...
        <Emoji :emojis="emojis" />
        <ExportPDF
          :modelValue="articleForm.articleContent"
          height="700px"
          @onSuccess="onSuccess"
      ...
      <template #footer>
        <div class="dialog-footer">
          <el-button
            ...
            >发布文章</el-button
          >
          <el-button v-else type="danger" @click="submitForm"
            >保存草稿</el-button
          >
...
const openModel = () => {
  ...
  if (articleForm.value.articleDesc === "") {
    articleForm.value.articleDesc = removeSpecialChars(
